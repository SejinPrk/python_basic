...
c1.cus_mul(1000)
# c1.cus_replace(1000, 7777) # old: 1000, new: 7777
c1.cus_replace(1000, 'hahaha') # old: 1000, new: 'hahaha'
...
# Ex2
# Custom Metaclass 생성 예제(Type 상속 o)
...
# 상속 확인
print(CustomList2.__mro__) # mro: Method Resolution Order